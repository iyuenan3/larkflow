...
当前前端边界是飞书责任入口加 Owner 中央只读控制台。节点 Owner 继续在飞书完成工作；Instance Owner 可以查看本人流程、DAG、历史 Attempt 和审计。控制台不建立第二套状态，不提供领域写操作，开发期只通过 loopback 和 SSH 隧道访问。生产登录与可写控制面仍未实现。
