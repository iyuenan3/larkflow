...
| ARCHITECTURE | ✅ | Target 模块化单体、事务仓储、Runtime / Projection / Inbound Worker 和剩余差距 |
| RELATIONS | ✅ | Target 飞书、中央 lark-cli、Node Runner、Projection 与 LangGraph 边界 |
| ROADMAP | ✅ | Phase 0 已完成，Phase 1 已落领域内核、持久化、Runtime、Task Projection 与 Task 入站 |
...
| CHANGELOG | ✅ | Append-only 已实现变更，最新为飞书 Task 耐久入站 |
