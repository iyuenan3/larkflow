...
> 飞书原生的**通用**交付物流转工作流引擎（LangGraph 驱动，落到人）｜ 生命周期: 引擎 v1.0 核心 headless 跑通 + 通用性收口 · 待接真栈
...
| DECISIONS | ✅ | ADR-001..029（012-018 第二轮；019 前端；020 handle 权威；021-025 入口/生成/打回权限/子项目/投票分支；026-029 tool 能力库/护栏①降级/屏障/打回预算）|
...
| CHANGELOG | ✅ | …v0.2.0 产品最终形态 / v0.3.0 引擎 v1.0 headless / v0.4.0 通用性收口 |
