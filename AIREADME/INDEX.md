...
>
> last-synced: 5113a59aacc8b0a97481411e581b9d52f6462073 · 2026-08-05
...
| SPEC | ✅ | legacy 契约、Target CLI、独立 interact Worker、数据库通知唤醒、十一个飞书窄命令、模板与无模板草稿、人员选择与失败恢复卡、Task 入站、受控变化、完成投影与私有 Edge v1 HTTP、前台客户端、doctor 及 macOS manager |
...
| DECISIONS | ✅ | Append-only ADR 历史，最新记录无模板草稿入口的授权与能力边界 |
| CHANGELOG | ✅ | Append-only 已实现变更，最新为结构化无模板飞书草稿入口及真实闭环 |
