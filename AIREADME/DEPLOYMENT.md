...
- 当前 Target 与 legacy 应用 wheel 对应企业目录仓储提交 `a7f827f0f1bd4509d6c0f6cb69a8d3d404e3b33e`，并包含此前 Phase 2A、Phase 2B Agent Attempt 附件上下文、薄 Python 豆包 `SearchProvider` 和原生飞书 Docx 交付物。发布件位于 `/srv/larkflow/target/releases/knowledge_catalog_20260819_003122_a7f827f/larkflow-0.0.2-py3-none-any.whl`，SHA-256 为 `26cdfa46fcd61bddf03505f91b8704a07ef609df0b9d57f3f2e45c93c51c02c3`。两个 venv 的 `pip check` 通过，安装态 `knowledge/repository.py` SHA-256 与本地同为 `a13813a4401f81736f9c70b771377124fe7f32d5d369175832b118379790c18d`。十个 larkflow Python 服务均为 `active / running / NRestarts=0`，部署窗口 warning 及以上为 0。
...
- 企业目录 synthetic 探针保留 tenant `synthetic_knowledge_catalog_20260819_003122` 的 2 个不可变版本、1 个当前 published 版本和 3 条追加审计。v1 经发布与撤销后，v2 成为唯一当前版本；审计快照不含正文或 object key。该记录只验证开发仓储，不代表管理员授权、真实企业资料、管理 API 或知识读取已经完成。
