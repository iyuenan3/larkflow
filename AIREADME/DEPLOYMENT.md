...
> 当前候选状态：企业共享正文与 ContextBundle 代码已由 `88fd70ea5a29bdf7c9f84573fd45a951f73da88c` 和 `d76a65faca027a558bfadc9b395e5807247705e3` 提交，完整离线合并证据为 `1248 passed, 30 skipped`。本段以下开发环境仍运行旧的 metadata-only 企业资料版本，长期库仍为 `25 / 0025`；真实 PostgreSQL、0026 migration、Caddy、wheel 部署、服务回读和 synthetic Runtime 探针尚未执行。
...
- 当前 Target 与 legacy 应用 wheel 对应企业资料目录管理 API 提交 `fc2fc2e73ff0e4001d952f6cba7e4a20e6b04005`，并包含此前企业目录仓储、Phase 2A、Phase 2B Agent Attempt 附件上下文、薄 Python 豆包 `SearchProvider` 和原生飞书 Docx 交付物。发布件位于 `/srv/larkflow/target/releases/knowledge_api_20260819_005038_fc2fc2e/larkflow-0.0.2-py3-none-any.whl`，SHA-256 为 `c608eef5e6bd5ae85a95797ea61b2ca0d0dce5f87a31b10b1130f0d9f1e1c0e9`。两个 venv 的 `pip check` 通过，Target 与 legacy 安装态 `console_admin_knowledge.py`、`knowledge/repository.py` 和 `console_http.py` SHA-256 分别与本地 `7e4d041b7172bde7ddb91a445f18eb8c4a5b2919fa704a494abbc2e6caac1401`、`c9f0565af112632319d08b0ef55c91c6e9e9d9cdd9e3ebd4c6b11bdf66513049` 和 `d6041eecb5ae41406fe045a1606167c80ec3f6e5693e92fd3610d0abc5d56239` 一致。十个 larkflow Python 服务均为 `active / running / NRestarts=0`，部署窗口 warning 及以上为 0。
