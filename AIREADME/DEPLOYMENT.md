...
- 当前 Target 应用 wheel 对应 `9a70f033d800292972a8d627fd4dddc7e45d83b2`，包含 Phase 2A 附件、Agent 完成性、旅游 evidence policy、搜索能力预检、Runtime 结果规范化、公开错误说明、飞书安全富文本投影、no-web 直接来源依赖、正向证据复验和日期、人数、总预算的业务字段绑定。发布件位于 `/srv/larkflow/target/releases/field_binding_20260815_194043_9a70f03/larkflow-0.0.2-py3-none-any.whl`，大小为 1048520 bytes，SHA-256 为 `8b99b9bf5b6053c19b563f48c8694cdf802e9a750569f5ff4453d14f2648a396`。Target 与 legacy 安装态的 `draft_validation.py` SHA-256 都是 `849dbbeec499eddd35d7d0386862fbdf2bd64437426b71692d5e490024882361`，两个 venv 的 `pip check` 通过。十个 larkflow Python 服务均为 `active / running / NRestarts=0`，部署窗口 warning 级及以上日志为 0。
