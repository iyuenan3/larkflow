...
- 当前 Target 开发发布件对应内容提交 `770243a02b116e12583ceebdb8362fd40b7fe0a7`，在既有自然语言草稿、来源约束复核、返工上下文和 Owner 只读 Console 基础上增加暂停、继续与安全取消。长期库为十九份 migration，九个 Target 服务与一个 legacy 事件消费者均回读 `active / NRestarts=0`；生命周期 PostgreSQL 双连接竞争已通过，真实飞书命令与取消投影收口仍待验收。
