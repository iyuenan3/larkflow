...
- 当前 Target 应用 wheel 对应内容提交 `3d438bb476ad9b9f98cd4c2873802a2894718fe4`，管理员 allowlist 运维工具对应 `00b3c8f920e6b856d11d9d4a91678959de3da6a5`，systemd 出站边界对应 `bc961b6`。Caddy 通过公网 IP 的 80 / 443 端口提供 HTTPS；Console 继续只监听 `127.0.0.1:8780`。统一重启后九个 Target 服务、legacy 消费者与 Caddy 均回读 `active / running / NRestarts=0`。公网与 loopback `/console/` 均返回 200，未认证任务 API 返回 401。飞书 OAuth 应用凭证与管理员 allowlist 继续只保存在受限 env。
